...
from rlkit.envs.ant_shape import AntShapeEnv
...
def experiment(variant):
    ...
    env = NormalizedBoxEnv(AntShapeEnv(n_tasks=task_params['n_tasks'], use_low_gear_ratio=task_params['low_gear']))
...
def main(gpu, docker):
    ...
    variant = dict(
        task_params=dict(
            n_tasks=6, # 20 works pretty well
